            ...
            {days.map((day) => {
              ...
              return (
                <button
                  ...
                  className={`aspect-square rounded-lg border p-1 text-left text-xs transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] ${selected === key ? "border-[var(--accent)]" : "border-[var(--border)]"} ${isSameMonth(day, month) ? "opacity-100" : "opacity-40"}`}
